...
for subj in subjects:
   # define folder names and create them
    ...
    epochs = create_epochs(mfname,mont_fname,eve_fname,epo_fname,ev_id=ev_id)

    
    bln_fname = op.join(epo_dir,bln_filename.format(subj,ses))

    baseline = create_baseline_epochs(mfname,mont_fname,eve_fname,bln_fname,ev_id=ev_id)
